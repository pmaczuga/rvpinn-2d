...
z = f(pinn, x, t) + shift(x,t)
color = plot_color(z.cpu(), x.cpu(), t.cpu(), 100, 100)
...
pinn_init = f(pinn.cpu(), torch.zeros_like(x_init_raw).reshape(-1,1)+0.5, x_init_raw.reshape(-1, 1)) #x=0.5, t between (-1,1)
